...
# Per-column embedding dimensions
CAT_EMB_DIMS = {
    "genres":    16,
    "developer": 64,
    "publisher": 64,
...
# ---------------------------
# Auto batch size — multiple of 11
# ---------------------------
...
class GameFeatureEncoder(nn.Module):
    def __init__(self, numeric_dim, vocab_sizes, max_lens,
        ...
        # Per-column embedding tables with per-column dims
