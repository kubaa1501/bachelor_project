...
#      hyperparameters
# ---------------------------
# best hyperparameters selected earlier during search
...
num_epochs      = 20
# number of grouped training examples sampled per epoch
...
def collate_fn(batch):
    # stack grouped user-game indices and labels into batch tensors
...
class MLPBPR(nn.Module):
    ...
    def __init__(self, user_in_dim, game_numeric_dim,
        ...
        # MLP layers after concatenating user and game representations
        layers = []
...
for seed in SEEDS:
    ...
    # rebuild best checkpoint and evaluate final val/test ranking
    best_model = MLPBPR(
